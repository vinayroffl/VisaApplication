...
Note:
- Endpoints marked in <span style="color:GREEN">**GREEN**</span> color are accessed by anyone without authentication.
- Endpoints marked in <span style="color:ORANGE">**ORANGE**</span> color are accessed by any users who are authenticated.
- Endpoints marked in <span style="color:BLUE">**BLUE**</span> color are accessed by users who are
authenticated and has role **“OFFICER”**.
- Endpoints marked in <span style="color:RED">**RED**</span> color are accessed by users who are authenticated, and he/she needs to have role **“USER”**.
...
#### <span style="color:GREEN">**“user/login”**:</span> **Post Method**:  
...
#### <span style="color:ORANGE">**“visa/list”:**</span> **Get Method**:
...
**Request:**  
<span style="color:ORANGE">*localhost:8080/visa/list?applicationID=AID12345*</span>
...
#### <span style="color:RED">**“visa/add”:**</span> **Post Method:**
...
If tried to access the endpoint without token, return 401 status code.

#### <span style="color:BLUE">**“visa/update/{int:id}”:**</span> **Patch Method:**
...
#### <span style="color:RED">**“visa/delete/{int:id}”:**</span> **Delete Method:**
...
import com.fresco.Visa.Dto.DeleteDto;
...
public class Controller {
	...
	public ResponseEntity<Object> deleteApplication(int id){return null;}
	...
	public ResponseEntity<Object> updateApplication(int id, UpdateDto dto){return null;}
...
```
```java
package com.fresco.Visa.Filter;



import com.fresco.Visa.Config.UserInfoUserDetailsService;
import com.fresco.Visa.Services.JwtService;
...
import com.fresco.Visa.Config.UserInfoUserDetails;
...
import com.fresco.Visa.Auth.AuthenticationRequest;
//import com.fresco.Visa.Entities.Users;
//import com.fresco.Visa.Repositories.UsersRepository;
//import com.fresco.Visa.Security.JwtUtil;
import com.fresco.Visa.Filter.JwtAuthFilter;
